...
- Check that the skills symlink is installed and enabled (see below)
...
### Plugin not detected
- Ensure your clone path is correct: `~/.codex/forge`
- Check that the skills directory exists: `ls ~/.codex/forge/skills`
- Re-run the install commands (step 2)
